/**
* \file interface.h
* \brief Fonctions permettant de gerer l'interface, affichage de menus etc.
*\author Liu Yicheng 
*\version 1
*\date 12 avril 2019
*/
...
/**
* \fn void afficher_img(int x,int y,int h,int w,char img[50],image_t image[Z],SDL_Renderer *renderer,float coefZoom,int anim,SDL_Rect imgDestRect)
* \brief affichage d'une image
*/
/**
* \fn void loadImage(image_t image[Z],SDL_Renderer *renderer)
* \brief chargement d'une image
*/
/**
* \fn void AfficherText(char* message, char* fontFile, SDL_Color color, int fontSize,SDL_Renderer *renderer,int x,int y)
* \brief Affichage d'un texte
*/
/**
* \fn int draw_menu(SDL_Renderer *renderer,SDL_Window* pWindow)
