/**
*\file deplacement.h
*\brief Fonctions de déplacement des unités.
*\author Eliot Lepoittevin Willhem Liban
*\version 1
*\date 12 avril 2019
*/
 ...
 * \brief remplis la grille de jeu (terrain[x][y].deplacement= ?) selon si la case est apte au deplacement d'un allié SELECTIONNE
*/
/**
 * \fn void move(case_t terrain[N][M],int x,int y, int joueur,joueurs_t tab[J],bash_t tab_info_bash[TAILLE_TAB_BASH],char variable2[80])
 * \brief deplacement vers une coordonné x et y de la grille
 */
